...
class DuckChainAPIClient {
    ...
    async collectDailyEgg(authorization) {
        try {
            ...
            this.log(`Error while collecting eggs: ${error.message}`, 'error');
            return { success: false, error: error.message };
        }
    }
